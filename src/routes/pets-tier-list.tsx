...
const PetsTierListPage = lazy(() =>
  import("@/app/pets-tier-list/page").then((m) => ({ default: m.default })),
);

export const Route = createFileRoute("/pets-tier-list")({
  head: () => {
