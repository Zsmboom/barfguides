...
export default function SeedsDatabasePage() {
  return (
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <Section eyebrow="DATABASE" title="Build A Ring Farm Seeds Database">
        <p className="text-slate-400">All 35 seeds sorted by Outer Ring profit per minute. Use the tier list to plan your next seed purchase.</p>
      </Section>
