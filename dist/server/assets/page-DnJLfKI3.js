...
function FaqPage() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "mx-auto max-w-7xl px-4 py-12", children: [
      /* @__PURE__ */ jsx("p", { className: "text-sm font-bold uppercase tracking-[0.2em] text-emerald-300", children: "Build A Ring Farm questions answered" }),
      /* @__PURE__ */ jsx("h1", { className: "mt-3 text-4xl font-black text-white md:text-5xl", children: "Build A Ring Farm FAQ" }),
      /* @__PURE__ */ jsx("p", { className: "mt-4 max-w-3xl text-lg leading-8 text-slate-300", children: "The most common Build A Ring Farm questions, organized by topic. Use the categories below to jump to the answer you need, or run the profit calculator, codes list, and tier list for live tools that complement this FAQ." })
    ] }),
    categories.map((cat) => /* @__PURE__ */ jsx(Section, { title: cat.title, children: /* @__PURE__ */ jsx("div", { className: "grid gap-4 md:grid-cols-2", children: cat.items.map((item) => /* @__PURE__ */ jsx(InfoCard, { title: item.question, children: /* @__PURE__ */ jsx("p", { children: item.answer }) }, item.question)) }) }, cat.title)),
    /* @__PURE__ */ jsx(Section, { title: "Quick Links", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-4 md:grid-cols-2 lg:grid-cols-4", children: [
      ...
      /* @__PURE__ */ jsxs(InfoCard, { title: "Active Codes", children: [
    ...
    /* @__PURE__ */ jsx(DataDisclaimer, { dataType: "FAQ answers" })
  ] });
}
export {
  FaqPage,
